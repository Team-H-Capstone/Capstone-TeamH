...
const MyDashboard = () => {
    return (
        <div className="w-full h-screen flex flex-row" style={{background:"white"}}>
         <section
         className="top-0 left-0 w-72 bg-[#2b2d42] h-full border-r overflow overflow-auto pt-24"
         >
            ...
            <div className="overflow-y-auto overflow-x-hidden flex-grow pt-8">
                <ul className="flex flex-col space-y-4 text-xl">
                    <Link to="/forum">
                        <p href="#" className="relative flex flex-row items-center h-11 focus:outline-none text-[#edf2f4] hover:bg-[#f8f9fa] hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
