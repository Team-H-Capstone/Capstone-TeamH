...
const ChartOne = () => {
    return (
        <div style={{width:800}}>
            <h1 style={{fontSize:25, textAlign:"center"}}>According to the <em style={{fontStyle:"italic"}}>Institute for Health Metrics and Evaluation</em>, a study conducted in 2017 estimated that around 970 million people around the world lived with a mental health or substance abuse disorder. At the time, this would have accounted for nearly 13% of the world's population.</h1>
            <br></br>
